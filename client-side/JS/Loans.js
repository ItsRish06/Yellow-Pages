var url = 'http://127.0.0.1:8000/api/loans/active/?'
var scholarships;
var page = 1
...
async function getfields(url) {
    ...
    var filterFields = 'http://127.0.0.1:8000/api/loans/filterFields/'
...
form.addEventListener('submit', (e) => {
    e.preventDefault();
    url = "http://127.0.0.1:8000/api/loans/filter/?"
    var filterVal = {
...
search.addEventListener('submit', (e) => {
    e.preventDefault();
    page = 1
    url = "http://127.0.0.1:8000/api/loans/search/?"
    var filterVal = {
...
async function getState(country){
    url = `http://127.0.0.1:8000/api/loans/getState/?country=${country}`
...
async function getDistrict(state){
    url = `http://127.0.0.1:8000/api/loans/getDistrict/?state=${state}`
