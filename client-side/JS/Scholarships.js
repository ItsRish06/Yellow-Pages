var url = 'http://127.0.0.1:8000/api/scholarship/active/?'
var scholarships;
var page = 1
...
async function getfields(url) {
    ...
    var filterFields = 'http://127.0.0.1:8000/api/scholarship/filterFields/'
...
form.addEventListener('submit', (e) => {
    e.preventDefault();
    url = "http://127.0.0.1:8000/api/scholarship/filter/?"
    var filterVal = {
...
search.addEventListener('submit', (e) => {
    e.preventDefault();
    page = 1
    url = "http://127.0.0.1:8000/api/scholarship/search/?"
    var filterVal = {
...
async function getState(country){
    url = `http://127.0.0.1:8000/api/scholarship/getState/?country=${country}`
